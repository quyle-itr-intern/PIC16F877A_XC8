 ...
 * Author: levan
 *
 * Created on February 7, 2022, 8:28 PM
 */
...
#define MFRC522_CS_SET TRISCbits.TRISC0
#define MFRC522_CS PORTCbits.RC0
    
#define MFRC522_RS_SET TRISCbits.TRISC1
#define MFRC522_RS PORTCbits.RC1
