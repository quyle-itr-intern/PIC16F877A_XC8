...
#define _Kalman_h
  ...
  float      Q_angle = 0.001;
    ...
    unsigned char    P[0][0] = 0; // Since we assume tha the bias is 0 and we know the starting angle (use setAngle), the error covariance matrix is set like so - see: http://en.wikipedia.org/wiki/Kalman_filter#Example_application.2C_technical
    unsigned char      P[0][1] = 0;
    unsigned char      P[1][0] = 0;
    unsigned char      P[1][1] = 0;
