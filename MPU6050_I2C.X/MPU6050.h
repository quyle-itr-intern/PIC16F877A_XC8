...
//------------------------------------
#define IN1_SET TRISDbits.TRISD7
#define IN2_SET TRISDbits.TRISD6
#define IN1 PORTDbits.RD7
#define IN2 PORTDbits.RD6
    
#define IN3_SET TRISDbits.TRISD3
#define IN4_SET TRISDbits.TRISD2
#define IN3 PORTDbits.RD3
#define IN4 PORTDbits.RD2 
